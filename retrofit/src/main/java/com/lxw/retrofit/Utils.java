...
public final class Utils {
    ...
    //获取 使用泛型的 类型 如List<T>的rawType List,Map<T>的rawType Map
    ...
    public static Type getSupertype(Type context,
                                    Class<?> contextRawType, Class<?> supertype) {
            ...
            if (toResolve instanceof TypeVariable) {
                ...
                if (originalLowerBound.length == 1) {
                    ...
                    if (upperBound != originalUpperBound[0]) {
                        return new WildcardTypeImpl(new Type[]{upperBound}, EMPTY);
                    }
                }
                return original;
    ...
    private static final class WildcardTypeImpl implements WildcardType {
        ...
        public Type[] getLowerBounds() {
            return lowerBound != null ? new Type[]{lowerBound} : EMPTY;
        }
